...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the GIGIdesk network..."),
        ...
        ("install_tip", "Due to UAC, GIGIdesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install GIGIdesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant GIGIdesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant GIGIdesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow GIGIdesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [GIGIdesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next GIGIdesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant GIGIdesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant GIGIdesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running GIGIdesk."),
        ...
        ("verify_rustdesk_password_tip", "Verify GIGIdesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use GIGIdesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade GIGIdesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent GIGIdesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by GIGIdesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if GIGIdesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep GIGIdesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the GIGIdesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, GIGIdesk verifies the server certificate for protocols using TLS.\nWith this option enabled, GIGIdesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, GIGIdesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: GIGIdesk server OSS doesn't include this feature."),
